...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(in_array(7,$request->role)) {
            $data['is_marketing_manager'] = 1;
            $data['as_marketing_manager_verified'] = $request->marketingManagerVerify ? $request->marketingManagerVerify : 0;
        }
